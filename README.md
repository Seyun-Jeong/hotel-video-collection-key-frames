...
**Method and metric:**
- uniform temporal sampling doesn't have a context awareness - it's more extracting key frames in an evenly spaced manner so it doesn't capture the visual context effectively.
